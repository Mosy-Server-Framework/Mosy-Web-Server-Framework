...
typedef MosyValue(*RestfulControllerTamplate)(map<MosyValue, MosyValue>);
...
public:
	...
	MosyModuleInstance LoadMosyModule(MosyValue Path);
	...
	void FreeMosyModule(MosyModuleInstance ModuleInstance);
};
